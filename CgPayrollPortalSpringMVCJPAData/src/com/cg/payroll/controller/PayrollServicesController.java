...
PayrollServices payrollServices;
	...
	public ModelAndView getNetSalary(@RequestParam int associateId)throws AssociateDetailsNotfoundException{
		int netSal=payrollServices.calculateNetSalary(associateId);
		return new ModelAndView("calculateNetSalaryPage", "associateId", netSal);
	}
}
